        ...
        <section className="relative">
          <div className="max-w-7xl mx-auto px-4 py-16">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 px-3 py-1 mb-4 text-2xs font-medium text-green-400 bg-green-400/10 rounded-full border border-green-400/20">
                <BarChart3 className="h-3 w-3" />
                Share Trading
              </div>
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-emerald-400 to-teal-400">Share Investment</span>
              </h1>
              <p className="text-gray-400 max-w-2xl mx-auto text-sm">Invest in top global equities with leverage and fractional shares</p>
            </div>
              ...
              <div className="group">
                <div className="relative p-px rounded-2xl overflow-hidden">
                  ...
                  <div className="relative bg-dark-300 rounded-2xl p-5 border border-gray-800 group-hover:border-brand-blue/50 transition-all">
                    ...
                    <h3 className="font-bold text-white mb-1 text-sm">US Stocks</h3>
                    <p className="text-gray-400 text-2xs">Apple, Google, Amazon, Tesla</p>
                  </div>
                </div>
              </div>
              <div className="group">
                <div className="relative p-px rounded-2xl overflow-hidden">
                  ...
                  <div className="relative bg-dark-300 rounded-2xl p-5 border border-gray-800 group-hover:border-green-400/50 transition-all">
                    ...
                    <h3 className="font-bold text-white mb-1 text-sm">Leverage</h3>
                    <p className="text-gray-400 text-2xs">Up to 5x leverage available</p>
                  </div>
                </div>
              </div>
              <div className="group">
                <div className="relative p-px rounded-2xl overflow-hidden">
                  ...
                  <div className="relative bg-dark-300 rounded-2xl p-5 border border-gray-800 group-hover:border-indigo-400/50 transition-all">
                    ...
                    <h3 className="font-bold text-white mb-1 text-sm">Regulated</h3>
                    <p className="text-gray-400 text-2xs">FCA compliant trading</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="text-center">
              <Link href="/dashboard/investments" className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-medium text-black bg-gradient-to-r from-green-600 to-emerald-500 rounded-xl hover:opacity-90 transition-all">
                Start Share Trading
